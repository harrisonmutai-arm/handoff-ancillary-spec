...
https://github.com/FirmwareHandoff/ProjectSpecificTransferEntries

Developer Certificate of Origin certification
---------------------------------------------

Anyone may contribute to the ProjectSpecificTransferEntries which is an
auxiliary document from the FirmwareHandoff project. Contributions are
...
Any contribution must contain the sign-off line at the end of the explanation
n every patch message.
